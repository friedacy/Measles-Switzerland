...
for (pair in canton_pairs) {
  ...
  filename <- paste0("output/Coherence/wpavg_", pair[1], "_", pair[2], ".pdf")
  filename_image <- paste0("output/Coherence/wpimage_", pair[1], "_", pair[2], ".pdf")
  
  # Erstelle den Coherence-Plot
  ...
  pdf(file = filename_image, width = 15, height = 10)
